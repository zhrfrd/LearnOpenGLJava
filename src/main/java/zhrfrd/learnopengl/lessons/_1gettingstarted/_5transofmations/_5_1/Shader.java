package zhrfrd.learnopengl.lessons._1gettingstarted._5transofmations._5_1;
...
public class Shader {
    ...
    public void setVec2(String name, float x, float y) {
        GL33.glUniform2f(GL33.glGetUniformLocation(id, name), x, y);
    }

    public void setVec3(String name, float x, float y, float z) {
        GL33.glUniform3f(GL33.glGetUniformLocation(id, name), x, y, z);
    }

    public void setVec4(String name, float x, float y, float z, float w) {
        GL33.glUniform4f(GL33.glGetUniformLocation(id, name), x, y, z, w);
    }

    public void setMat4(String name, FloatBuffer matrix) {
        GL33.glUniformMatrix4fv(GL33.glGetUniformLocation(id, name), false, matrix);
    }
